    ...
    <form action="{{ route('datosgenerales.update', $general->id) }}" method="POST">
      ...
      <div
        ...
        <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
          <h2 class="font-semibold text-slate-800 dark:text-slate-100 text-2xl tracking-tight">Datos generales del
            negocio</h2>
        </header>
        @if (session('success'))
          <script>
                    ...
                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1">
                      ...
                      <div class="lg:col-span-1">
                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                          ...
                          <h2 class="md:col-span-5 text-lg font-semibold text-slate-800 dark:text-white">Información de
                            contacto</h2>
                          ...
                          <div class="md:col-span-2">
                            ...
                            <div class="relative mb-2">
                              ...
                              <input type="text" id="district" name="district" value="{{ $general->city }}"
                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Interior Oficina 204 - Piso 4">
                            </div>
                          </div>
                          ...
                          <h2 class="md:col-span-5 text-lg font-semibold text-slate-800 mt-2 dark:text-white">Redes
                            Sociales</h2>
